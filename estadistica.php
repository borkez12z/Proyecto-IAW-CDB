<?php
    ...
    class estadistica{
        ...
        public function insertar2(){
            ...
            $insert2=$conexion->prepare('INSERT INTO estadisticas_jugador_up (ID_JUGADOR,PUNTOS_ULTIMO_PARTIDO,MINUTOS_ULTIMO_PARTIDO,FALTAS_ULTIMO_PARTIDO) values(:id_jugador, :puntosultimopartido, :minutosultimopartido, :faltasultimopartido)');
        ...
        public function actualizado(){
            $conexion= new conexion();
            $actualizare= $conexion->prepare('UPDATE estadisticas_jugador_up SET PUNTOS_ULTIMO_PARTIDO = :puntosultimopartido, MINUTOS_ULTIMO_PARTIDO = :minutosultimopartido, FALTAS_ULTIMO_PARTIDO = :faltasultimopartido where id_jugador = :id_jugador');
